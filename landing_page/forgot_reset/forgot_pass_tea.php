    ...
    <div class="container" style="width: 500px;">
        ...
        <div class="card-footer text-center">
            ...
            <div class="col-lg-5 d-flex justify-content-center">
                <!-- form start -->
                <form class="forgot-pass" data-user-type="teacher">
                    <div id="forgotAlert_tea"></div>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="submit"  id="forgot-btn-tea" class="btn btn-primary "
                            style="width: 320px;" value="Reset password">
                    </div><br><br>
                    <center>
                        <p><a href="../Login_Section/TLogin/Tlogin.php">Log
                                in</a></p>
                    </center>

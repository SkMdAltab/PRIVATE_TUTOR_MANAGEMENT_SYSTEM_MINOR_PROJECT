    ...
    if ($auth_user != null) {
        if (isset($_POST['reset_btn'])) {
            ...
            if ($newpass == $cpass) {
                ...
                $msg = "password changed successfully!<br> <a href='http://localhost/prototype_minor_Project/landing_page/Login_Section/SLogin/Slogin.php'>Login here!</a>";
...
<body>
    <div class="container" style="width: 500px;">
        ...
        <div class="row justify-content-center border rounded-4 border-2">
            <div class="col-lg-5 d-flex justify-content-center">
                <!-- form start -->
                <form class="reset-pass" method="post" data-user-type="student">
                    ...
                    <div class="form-group">
                        ...
                        <input type="submit" name="reset_btn" id="reset_btn_stu" class="btn btn-primary "
    ...
    <script src="http://localhost/minor_Project/assets/js/script.js"></script>
